...
<!DOCTYPE html>
	<html lang="pt-BR">
		...
		<body>
			...
			<form id="myAjaxRequestForm" name="cadastra_entidade" accept-charset="utf-8" action="mvc" method="post">
				Nome:<br /> 
				...
				<input type="submit" value="Salvar" id="salvar" />
			 	...
			 	<input type="hidden" value="CadastraEntidadeLogica" name="logica" id="logica"/>
			</form><br/>
